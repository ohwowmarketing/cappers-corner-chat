...
<div class="--cappers-chat-plugin">
    <div class="ui-comments">
        <form action="" class="ui-comments-msgboard uk-animation-toggle" tabindex="0" id="replyForm">
            ...
            <?php else : ?>
                <a href="#login-panel" class="ui-cm-field" uk-toggle="animation: uk-animation-fade">Login or join now to post a reply</a>
            <?php endif; ?>
        </form>
            ...
            <div class="ui-ch-action">
                <div class="ui-ch-moreaction">
                    ...
                    <div class="ui-ch-moreaction">
                        ...
                        <div uk-dropdown="offset: 13; pos: bottom-right">
                            <ul class="uk-nav uk-dropdown-nav">
                                ...
                                <?php else : ?>
                                    <li><a id="register-btn" href="#register-panel" uk-toggle>Join Now</a></li>
                                    <li><a id="login-btn" href="#login-panel" uk-toggle>Login</a></li>
                                <?php endif; ?>
                            </ul>
                        </div>
                    </div>
